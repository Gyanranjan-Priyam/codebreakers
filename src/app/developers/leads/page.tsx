...
function DeveloperCard({ image, title, subtitle, handle, borderColor, gradient, url, email, socials }: DeveloperCardProps) {
  return (
    <div className="group block relative h-full">
      <div
        className="relative h-full overflow-hidden border border-primary/30 bg-panel transition-all duration-300 group-hover:border-primary/70 group-hover:shadow-[0_0_30px_var(--primary)]"
      >
        {/* CRT scanlines */}
        ...
        <div className="relative aspect-square overflow-hidden">
          <div className="pointer-events-none absolute inset-0 bg-linear-to-b from-transparent to-background/80 z-10" />
          <Image
            src={image}
            alt={title}
            fill
